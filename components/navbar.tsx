        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          {isLoggedIn ? (
             <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-sm font-medium border border-neutral-200 dark:border-neutral-800 rounded-full py-1.5 px-3 bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-white transition-colors">
                  {user.image ? (
          ...
          <div className="border-t border-neutral-200 dark:border-neutral-800 pt-4">
             {isLoggedIn ? (
               <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-3 text-sm font-medium px-3 py-2.5 text-neutral-900 dark:text-white bg-neutral-50 dark:bg-neutral-900 rounded-lg transition-colors">
                    {user.image ? (
