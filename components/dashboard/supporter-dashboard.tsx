      ...
      <div className="flex flex-col xl:flex-row gap-8 mb-8">
        ...
        <div className="w-full xl:w-80 flex flex-col gap-8">
           ...
           <div className="bg-emerald-500 dark:bg-[#004F3B] rounded-3xl p-6 shadow-lg shadow-emerald-500/20 dark:shadow-[#004F3B]/20 text-white h-auto relative overflow-hidden">
             ...
             <button className="mt-6 w-full py-2.5 bg-white text-emerald-600 dark:text-[#004F3B] rounded-xl font-bold text-sm hover:bg-emerald-50 dark:hover:bg-white/90 transition-colors relative z-10">
               View Full Report
             </button>
           </div>
        </div>
