    ...
    <div className="p-6 md:p-8 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-neutral-400 font-medium">Home / <span className="text-emerald-500 dark:text-[#004F3B]">Overview</span></p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <div className="bg-white dark:bg-neutral-900 rounded-3xl p-6 shadow-[0_2px_20px_rgb(0,0,0,0.04)]">
          <div className="flex justify-between items-start mb-4">
            <div className="w-12 h-12 bg-emerald-50 dark:bg-[#004F3B]/20 text-emerald-500 dark:text-[#004F3B] rounded-xl flex items-center justify-center">
      ...
      <div className="flex justify-between items-center mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-xs text-neutral-400 font-medium">
         <div className="flex gap-6">
            <Link href="#" className="hover:text-emerald-500 dark:hover:text-[#004F3B] transition-colors">Creator Guidelines</Link>
            <Link href="#" className="hover:text-emerald-500 dark:hover:text-[#004F3B] transition-colors">Help Center</Link>
         </div>
         <p>© 2026 FundForge</p>
      </div>
